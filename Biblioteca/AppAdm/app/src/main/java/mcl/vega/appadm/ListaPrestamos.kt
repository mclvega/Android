...
class ListaPrestamos : AppCompatActivity(), JsonPrestamos.ObtenerPrestamos.OnTaskCompleted {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var tarea=JsonPrestamos.ObtenerPrestamos("",this)
        tarea.execute("http://librosmcl.somee.com/servicios.svc/Listarprestamos")
